...
This portfolio includes examples of the work I've done for my Introduction to GIS and GPS for Scientists (SIO 110) course at University of California, San Diego.

## Public Fruit Trees in San Diego

For our final project, my two group members and I worked to create an ArcGIS StoryMap with an incorporated web map to share the locations of public fruit trees around UC San Diego.
